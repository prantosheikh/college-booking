          ...
          <div className="w-1/2 mx-auto">
            <div className="input-group flex flex-col">
              ...
              >
                ...
                <button
                  type="submit"
                  className="ml-2 px-4 py-2  transition-transform bg-blue-500 text-white rounded-md focus:outline-none"
                >
                  Search
                </button>
              </form>
            ...
            <div
             ...
             data-aos-offset="500"
             data-aos-duration="2000"
              className="bg-slate-200 opacity-90   border-e-8 border-blue-500 lg:w-full rounded-tl-3xl px-8 py-7 mt-4"
            >
              <h1 className="lg:text-4xl font-bold text-black">
                Let us help you to find
                <br /> <span className="text-blue-500">Your College</span>
              </h1>
              <p className="text-gray-700 mb-5 hidden lg:block">
                Discover the perfect educational journey that matches your
                aspirations and goals. Explore a world of possibilities and find
                your ideal college experience.
              </p>
              <div className="mt-4 lg:mb-3">
                <Link className="py-2 px-3 lg:px-8 -translate-y-6 scale-75 text-gray-800 border-2 border-blue-500 rounded-2xl hover:bg-blue-500 transform hover:text-white">
                  Get Started
                </Link>
              </div>
            </div>
